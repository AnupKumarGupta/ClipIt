...
namespace ClipIt
{
    public partial class ClipBoardHome : Form
    {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            //}
            //#endregion
            //if ((Win32.Msgs)m.Msg == Win32.Msgs.WM_COPY)
            //{
            //    GetClipboardData();
          ...
          //  Win32.User32.SendMessage(proc.MainWindowHandle, (UInt32)WM_PASTE, (IntPtr)0, (IntPtr)0);

            if ((Win32.Msgs)m.Msg == Win32.Msgs.WM_HOTKEY)
            {
                ctlClipboardText.Text = "CUT";
            }
